...
if (SERVER) then
	...
	function ENT:Toggle(client)
		...
		if (!client:IsCombine() and client:Team() != FACTION_ADMIN and client:GetCharacter():GetClass() != CLASS_CWU and !self:HasKey(client)) then 
			self:DisplayError()
	...
	local color_yellow = Color(223, 204, 36, 255)
